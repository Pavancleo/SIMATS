...
`;
  ...
  return (
    <div id="cybersentinel-recommendations-panel" className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        {recommendations.map((rec, idx) => (
          <div
            key={idx}
            id={`rec-card-${idx}`}
            className="p-4 bg-slate-950/70 border border-slate-800/90 rounded-xl flex items-start gap-3 hover:border-slate-700 transition-all"
          >
