...
export const AnalysisOverview: React.FC<AnalysisOverviewProps> = ({
  ...
  return (
    <div className="container">
      <div id="cybersentinel-overview-card" className="card p-5 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-5 items-stretch relative z-10">
          ...
          <div className="container">
            <div className="card flex flex-col items-center justify-between p-4 text-center">
              <div className="innerText text-[12px] font-semibold uppercase tracking-wider mb-2">
          ...
          <div className="container">
            <div className="card flex flex-col justify-between p-4 space-y-3">
              <div className="innerText text-[12px] font-semibold uppercase tracking-wider">
            ...
            <div className="card p-4 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="innerText text-[12px] font-semibold uppercase tracking-wider flex items-center gap-1.5">
                ...
                <p className="desc text-xs text-slate-300 leading-relaxed font-sans line-clamp-4">
